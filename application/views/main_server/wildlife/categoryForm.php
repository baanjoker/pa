			...
			<div class="panel panel-info">
				...
				<?php endif ?>
					...
					<div class="panel-body">
						...
						<div class="col-md-12">
					     <?php echo form_open('','class="form-horizontal" id="categoryForm"');
					     if (!empty($identifier)){
						 echo form_hidden('id',$wcat->id);
						 } else {
						 echo form_hidden('id');
						 } ?>
					...
					<div class="box-footer" >
						<div class="col-md-12">	
							<div class="form-group">
								<?php if (!empty($identifier)): ?>
									<button class="btn btn-success btn-flat" id="save_category"><i class="fa fa-save"> UPDATE</i></button>
								<?php else: ?>
									<button class="btn btn-info btn-flat" id="save_category"><i class="fa fa-save"> SAVE</i></button>
								<?php endif ?>
								
								<a class="btn btn-danger btn-flat pull-right" href="<?= base_url('main_server/wildlife/Category') ?>"><i class="fa fa-list"> List of Category</i></a>
							</div>
						</div>
					</div>
			</div>
...
<script type="text/javascript" src="<?php echo base_url("jquery/category.js") ?>"></script>