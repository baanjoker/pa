...
<div class="wrapper">
  <div class="sidebar" data-background-color="black" data-active-color="danger">
    <div class="sidebar-wrapper">
      <div class="logo">
        <!-- <p><?php echo $muncipalId ?></p> -->
      <a href="" class="simple-text">CENRO-<?php echo $read->municipalName ?> </a>
      </div>

      <ul class="nav">
        <li class="<?php if($this->uri->segment(2) == "dashboard"){echo 'active';}?>">
          <a href="<?php echo base_url('cenro/dashboard'); ?>">
        ...
        <li class="<?php if($this->uri->segment(3) == "ipaf"){echo 'active';}?>">
          ...
          <div class="collapse" id="mapsExamples">
            <ul class="nav">
             <!--  <li>
                <a href="<?php echo base_url('cenro/report/ipaf/byMonth'); ?>" style="color: #40ff00">
                  <i class="ti-calendar"></i>
                  <span class="sidebar-mini">By</span>
                  <span class="sidebar-normal">Yearly</span>
                </a>
              </li> -->
              <li>
                <a href="<?php echo base_url('cenro/report/ipaf/byYear'); ?>" style="color: #40ff00">
                  <span class="sidebar-mini">By</span>
                  <span class="sidebar-normal">Quarterly</span>
                </a>
              </li>  
              <li>
                <a href="<?php echo base_url(''); ?>" style="color: #40ff00">                 
                  <span class="sidebar-normal">Disbursement</span>
                </a>
              </li>             
            </ul>
          </div>
