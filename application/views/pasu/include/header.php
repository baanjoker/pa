...
<div id="myModal" class="modal fade in" role="dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-body">      
      ...
      <hr>
      <?php echo form_open('#','id="formChangePass"') ?>
...
<div id="myModalProfile" class="modal fade in" role="dialog">
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <button type="button" name="btnprofile" id="submitprofile" class="btn btn-info btn-fill btn-wd" onclick="insert_profile()">Update Profile</button>
      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
    </div>
  </div>
  </div>
...
<div class="wrapper">
  <div class="sidebar" data-background-color="black" data-active-color="danger">
    <div class="sidebar-wrapper">
      <div class="logo">
      <a href="" class="simple-text">Protected Area Superintendent </a>
      </div>

      <ul class="nav">
        <li class="<?php if($this->uri->segment(2) == "dashboard"){echo 'active';}?>">
          <a href="<?php echo base_url('pasu/dashboard'); ?>">
            <i class="ti-dashboard"></i>
            <p>Dashboard</p>
          </a>
        </li> 
        <li class="<?php if($this->uri->segment(2) == "pamain"){echo 'active';}?>">
          <a href="<?php echo base_url('pasu/pamain'); ?>">
            <i class="ti-import"></i>
            <p>New Protected Area</p>
          </a>
        </li>
        <li class="<?php if($this->uri->segment(3) == "ipaf_report"){echo 'active';}?>">
          ...
          <div class="collapse" id="mapsExamples">
            <ul class="nav">
              <li>
                <a href="<?php echo base_url('pasu/report/ipaf'); ?>" style="color: #40ff00">
                  <i class="ti-calendar"></i>
                  <span class="sidebar-mini">By</span>
                  <span class="sidebar-normal">Month</span>
                </a>
              </li>
              <li>
                <a href="<?php echo base_url('pasu/report/ipaf/byDate'); ?>" style="color: #40ff00">
                  <i class="ti-yahoo"></i>
                  <span class="sidebar-mini">By</span>
          ...
          <!-- <a href="<?php echo base_url('pasu/report/ipaf'); ?>">
            <i class="ti-import"></i>
            <p>IPAF Report</p>
          </a> -->
        </li>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <?php if ($this->session->userdata('user_role') == 3): ?>
                  <p><strong>PASU-<?php echo $read->lastname ?></strong></p>                
                <?php endif ?>
