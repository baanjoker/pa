			...
			<div class="panel panel-info">
				...
				<div class="panel-body">					
					<table width="100%" border="0" cellpadding="3" cellspacing="1" class="table4">
						<?php echo form_open('report/printpdf/cavesprint','id="formSearch"') ?>
						...
						<tr valign="top" class="spaceUnder">
							<td><button type="button" name="btnfilter" id="btnfilter" onclick="getMe()"  class="btn btn-success  btn-flat"><i class="fa fa-search"> Apply Filter</i></button></td>
					...
					<div class="table-responsive">
				    		...
				    		<thead>
				    		 ...
				    		 <tbody id="tbodycavefilter"></tbody>				    		
				    	</table>
						</div>
				</div>
			</div>
