			...
			<div class="panel panel-info">
				...
				<div class="panel-body">					
					<table width="100%" border="0" cellpadding="3" cellspacing="1" class="table4">
						<?php echo form_open('report/printpdf/wetlandpdf','id="formSearch"') ?>
						...
						<tr valign="top" class="spaceUnder">
							<td><button type="button" name="btnfilter" id="btnfilter" onclick="getMeWetland();"  class="btn btn-success  btn-flat"><i class="fa fa-search"> Apply Filter</i></button></td>
							<td colspan="5"><?php echo form_submit('', 'Export to PDF','class="btn btn-info btn-flat"'); ?></td>						
							<!-- (array('name' => 'form_submit', 'type' => 'submit', 'class' => 'btn btn-info btn-flat', 'content' => '<i class="fa fa-search fa-fw"></i> Search')) -->
							<!-- <td colspan="5"><a type="button" name="searchbut" class="btn btn-info btn-flat" target="_blank" href="<?php echo base_url ('report/printpdf/pdfprint') ?>"><i class="fa fa-file-pdf-o"></i><span> Generate Report</span></a></td>							 -->
						</tr>
					</table>	
					<?php form_close(); ?>
					<div class="table-responsive">
				    		...
				    		<thead>
				    		 ...
				    		 <tbody id="tbodywetlandfilter"></tbody>				    		
				    	</table>
						</div>
				</div>
			</div>
