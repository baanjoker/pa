	...
	public function pdffilepa($gencode=null)
    {
        ...
        $pdf->AddPage('P','A4',0);      
            ...
            if ($chk_pasu == 1) {
                ...
                foreach ($pasu_info as $pasu) {
                    $table->rowStyle('border:;border-color:#a1a1a1;');
                    $table->easyCell(iconv("UTF-8", '','<s "font-color:#234fa7"></s> '.(!empty($pasu->mobile)?$pasu->mobile." / ":"").$pasu->landline.(!empty($pasu->email)?$pasu->email:"")));
                    $table->rowStyle('border:;border-color:#a1a1a1;');
                    $table->easyCell(iconv("UTF-8", '','<s "font-color:#234fa7"></s> '.(!empty($pasu->apasu_mobile)?$pasu->apasu_mobile." / ":"").(!empty($pasu->apasu_email)?$pasu->apasu_email:"")));
                }
                    $table->printRow();
            ...
            if ($chk_legal==1) {
                ...
                $table=new easyTable($pdf, '{47.5,47.5,47.5,47.5}', 'font-size:12');
                    ...
                    foreach ($legalstatusNew as $legstat) {    
                        ...
                        $table->rowStyle('border:TBLR;border-color:#a1a1a1;bgcolor:#009879;font-color:#ffffff');
                            $table->easyCell(iconv("UTF-8", '','History of Establishment'),'align:C;font-color:#fff;colspan:4');
                        $table->printRow();  
        ...
        $chk_mangrove 	=1;
        $chk_habitateco =1;
        if ($chk_habitateco==1 || $chk_forfor == 1 || $chk_vegetative==1 || $chk_inwet==1 || $chk_caves==1 || $chk_coral==1 || $chk_seagrass==1 || $chk_mangrove==1) {           
                            ...
                            if (!empty($forfor)) {  
                                if ($countforforimage <= 0) {
                                    ...
                                    foreach ($forfor as $ff) {                    
                                        $table->easyCell("FOREST FORMATION \n",'img:bmb_assets2/upload/ff_map_img/'.$ff->ff_map_img.', w280, h250;font-style:bold;font-color:#FFF');  
                                    }
                                }
                            }
                            $table->printRow();
                                ...
                                if (!empty($vegetative)) {  
                                    if ($countvegetative <= 0) {
                                        ...
                                        foreach ($vegetative as $vege) {                    
                                            $table->easyCell("VEGETATIVE COVER \n",'img:bmb_assets2/upload/vegetative_img/'.$vege->vegetative_img.', w280, h250;font-style:bold;font-color:#FFF');  
                                        }
                                    }
                                }
                            $table->printRow();
                            ...
                            $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879;font-color:#fff;');
                                if (!empty($inland_wetland)) {  
                                    foreach ($inland_wetland as $iw) {                    
                                        $table->easyCell("INLAND WETLAND \n",'img:bmb_assets2/upload/iwmap/'.$iw->iw_img.', w280, h250;font-style:bold');  
                                    }
                                }
                            $table->printRow();
                        $table->endTable();
                        ...
                        foreach ($caves as $cavem) {
                            $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                                ...
                                if (empty($cavem->cavemap_img)) {
                                    ...
                                    $table->easyCell("CAVES \n",'img:bmb_assets2/upload/cavemap_img/'.$cavem->cavemap_img.', w280,h250;font-style:bold');                                
                                }
                                $table->printRow();
                            $table->endTable();
                        } 
                ...
                if ($chk_coral == 1) {                
                    if (!empty($coralreef) || !empty($coralreef_details_query) || !empty($coralreefspecies_details_query)){  
                        ...
                        if (empty($coral->coralreefmap)) {
                            ...
                            $table->easyCell("CORAL REEFS \n",'img:bmb_assets2/upload/coralreef_map_img/'.$coral->coralreefmap.', w280,h250;font-style:B');                                
                        } 
                        $table->printRow();
                    $table->endTable();     
                        }           
                    ...
                    if (!empty($seagrass) || !empty($seagrass_details_query) || !empty($seagrassspecies_details_query)){                        
                            ...
                            foreach ($seagrass as $seg) {
                                $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                                    ...
                                    if (empty($seg->seagrass_map)) {
                                        ...
                                        $table->easyCell("SEAGRASS BEDS \n",'img:bmb_assets2/upload/seagrass_map/'.$seg->seagrass_map.', w280,h250;font-style:B');                                
                                    } 
                                    $table->printRow();
                                $table->endTable();     
                            }
                        ...
                        $table=new easyTable($pdf, '{100,90}', 'width:100; border-color:#ffff00; font-size:12; border:1;');
                            ...
                            foreach ($seagrass_details_query as $seagrass) { 
                                $table->rowStyle('border:TBLR;border-color:#a1a1a1;');
                                    $table->easyCell(iconv("UTF-8", '',"Cover value(%) : ".$seagrass->seagrass_cover_value."%\nSeagrass Condition : ".$seagrass->seagrass_condition."(".$seagrass->seagrass_coverage.")\nDiversity value : ".$seagrass->diversity_value."\nDiversity Index : ".$seagrass->diversity_indexs."\nDate conducted : ".$seagrass->month." ".$seagrass->year),'align:L');
                    ...
                    if (!empty($mangrove) || !empty($mangrove_details_query) || !empty($mangrovespecies_details_query)){ 
                            ...
                            $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879;font-color:#fff');
                                foreach ($mangrove as $mangrov) {
                                    if (empty($mangrov->mangrove_map)) {
                                        ...
                                        $table->easyCell("MANGROVE FORESTS \n",'img:bmb_assets2/upload/mangrove_map/'.$mangrov->mangrove_map.', w280,h250;font-style:B');                                
                                    } 
                                } 
                            $table->printRow();
                        $table->endTable();   
                        ...
                        $table=new easyTable($pdf, '{130,60}', 'width:100; border-color:#ffff00; font-size:12; border:1;');
                            ...
                            foreach ($mangrove_details_query as $mangroves) { 
                                $table->rowStyle('border:TBLR;border-color:#a1a1a1;');
                                    $table->easyCell(iconv("UTF-8", '',(!empty($mangroves->mangrove_condition)?"<b>Condition : </b>".$mangroves->mangrove_criteria:"")."\n".(!empty($mangroves->crown_cover)?"<b>Actual Crown Cover: </b>".number_format($mangroves->crown_cover,2)."\n":"").(!empty($mangroves->regen_cat)?"\n<b>Condition : </b>".$mangroves->regen_category."(".$mangroves->regen_value.")":"")."\n<b>Actual Regeneration per m2: </b>".number_format($mangroves->regeneration,2)."\n".(!empty($mangroves->height_cat)?"\n<b>Condition : </b>".$mangroves->average_height_category."(".$mangroves->average_height_value.")":"").(!empty($mangroves->avg_height)?"\n<b>Actual Average Height : </b>".number_format($mangroves->avg_height,2)."\n":"").(!empty($mangroves->observe_cat)?"\n<b>Condition : </b>".$mangroves->observation_category:"").(!empty($mangroves->observation)?"\n<b>Actual Observation : </b>".$mangroves->observation."\n":"").(!empty($mangroves->divert_cat)?"\n<b>Condition : </b>".$mangroves->mangrove_conditions."(".$mangroves->mangrove_criteria.")":"").(!empty($mangroves->mangrove_diversity)?"\n<b>Actual value of diversity : </b>".$mangroves->mangrove_diversity."\n":"")
                                ),'align:L');
                        ...
                        $j=0;
                        $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0');
                            $table->rowStyle('border:TBLR;border-color:#a1a1a1;bgcolor:#009879');
                                $table->easyCell(iconv("UTF-8", '','Dominant Species'),'align:C');
                            $table->printRow();
        ...
        $biological = $this->pamain_report->query_pambbiological($gencode);
            ...
            $chk_ots = 1;
            $chk_iucn = 1;
        if ($chk_en == 1 || $chk_vu==1 || $chk_ew==1 || $chk_ex==1 || $chk_lc==1 || $chk_dd==1 || $chk_nt==1 || $chk_ne==1 || $chk_ots==1 || $chk_iucn==1) {
            $pdf->AddPage('P','A4',0);
            $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879'); 
                    ...
                    if (!empty($flooding_details_query)) {  
                        ...
                        // }else{ 
                            foreach ($flood_query as $data) {                    
                                $table->easyCell("FLOODING SUSCEPTIBILITY \n",'img:bmb_assets2/upload/flooding_img/'.(!empty($data->flooding_img)?$data->flooding_img:"nophoto.jpg").', w280, h250;font-style:B');  
                            }
                        // }
                    }                
                    $table->printRow();
                ...
                $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                    foreach ($ogeohazard_query as $data) { 
                        if (!empty($ogeohazard_details_query)) {  
                            ...
                            $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879;font-color:#fff');
                                $table->easyCell("OTHER GEOHAZARD FEATURES \n",'img:bmb_assets2/upload/other_geohazard_img/'.$data->geohazard_map.', w280, h250;font-style:B');  
                            $table->printRow();  
                            $table->rowStyle('border:;border-color:#a1a1a1');
        ...
        if ($chk_attraction==1 || $chk_facility==1 || $chk_products==1 || $chk_enterprise==1){
            ...
            if ($chk_attraction == 1) {
                if (!empty($count_attraction) || !empty($countMapAttraction)) {
                    // $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                    // $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879'); 
                    // $table->easyCell('ATTRACTION/ACTIVITIES', 'align:C;font-size:12;font-style:B;font-color:#fff');
                    // $table->printRow();             
                    // $table->endTable();                
                    $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                        $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879;font-color:#fff');
                        ...
                        if ($count_attraction <=0) {
                            ...
                            foreach ($query_attraction as $adet) {
                                ...
                                $query_attraction_img = $this->pamain_report->query_attraction_imgs($attcode);                                
                                    ...
                                    $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879;font-color:#fff');
                                    // $table->easyCell(iconv("UTF-8", '','<s "font-style:B;align:C">'.$adet->title.'</s>'."\n\n"
                                    // ),'align:C');
                                    // $table->printRow(); 
                                    $table->easyCell($adet->title."\n",'img:bmb_assets2/upload/attraction_img/'.(!empty($adet->image_attr)?$adet->image_attr:"nophoto.jpg"),'w280,h310;');                        
                                    $table->printRow();
                                    ...
                                    //     ($adet->chk_activity1==1?"Hiking/Trekking/Mountaineering".(($adet->chk_activity1==1 && $adet->chk_activity2==1)?", ":""):"").
                                    //     ($adet->chk_activity2==1?"Caving/Spelunking".(($adet->chk_activity2==1 && $adet->chk_activity3==1)?", ":""):"").
                                    //     ($adet->chk_activity3==1?"Scuba diving".(($adet->chk_activity3==1 && $adet->chk_activity4==1)?", ":""):"").
                                    //     ($adet->chk_activity4==1?"Snorkeling".(($adet->chk_activity4==1 && $adet->chk_activity5==1)?", ":""):"").
                                    //     ($adet->chk_activity5==1?"Swimming".(($adet->chk_activity5==1 && $adet->chk_activity6==1)?", ":""):"").
                                    //     ($adet->chk_activity6==1?"Kayaking".(($adet->chk_activity6==1 && $adet->chk_activity7==1)?", ":""):"").
                                    //     ($adet->chk_activity7==1?"Surfing".(($adet->chk_activity7==1 && $adet->chk_activity8==1)?", ":""):"").
                                    //     ($adet->chk_activity8==1?"Wildlife watching".(($adet->chk_activity8==1 && $adet->chk_activity9==1)?", ":""):"").
                                    //     ($adet->chk_activity9==1?"Bird watching".(($adet->chk_activity9==1 && $adet->chk_activity10==1)?", ":""):"").
                                    //     ($adet->chk_activity10==1?"Village tour".(($adet->chk_activity10==1 && $adet->chk_activity11==1)?", ":""):"").
                                    //     ($adet->chk_activity11==1?"Mangrove tours".(($adet->chk_activity11==1 && $adet->chk_activity12==1)?", ":""):"").
                                    //     ($adet->chk_activity12==1?"Science Museum tours".(($adet->chk_activity12==1 && $adet->chk_activity13==1)?", ":""):"").
                                    //     ($adet->chk_activity13==1?"Biking".(($adet->chk_activity13==1 && $adet->chk_activity14==1)?", ":""):"").
                                    //     ($adet->chk_activity14==1?"Nature photography".(($adet->chk_activity14==1 && $adet->chk_activity15==1)?", ":""):"").
                                    //     ($adet->chk_activity15==1?$adet->other_activity:"")
                                    // ),'align:L');
                                    // $table->printRow();
            ...
            if ($chk_facility==1) {
                ...
                // $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                //     $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879'); 
                //     $table->easyCell('FACILITY', 'align:C;font-size:12;font-style:B;font-color:#fff');
                //     $table->printRow();             
                //     $table->endTable();                
                    $table=new easyTable($pdf, '{190}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                        $table->rowStyle('border:;border-color:#a1a1a1;bgcolor:#009879');
                        if ($countMapfacility <= 0) {
                            $table->easyCell("FACILITY \n",'img:bmb_assets2/upload/facility_map/nophoto.jpg','w280,h250;font-style:B;font-color:#fff');
                        } else {
                            foreach ($facilMap as $facility) {
                                $table->easyCell("FACILITY \n",'img:bmb_assets2/upload/facility_map/'.$facility->facility_map.',w280,h250;font-style:B;font-color:#fff');
                            }
                        }
    ...
    if ($chk_program == 1 || $chk_project == 1 || $chk_research == 1 || $chk_prgActivity == 1 || $chk_prgProject == 1 || $chk_prgResearch == 1){
        if (!empty($program) || !empty($project) || !empty($research)) {            
            ...
            if ($chk_project==1) {
                if (!empty($project)) {
                    ...
                    $table->endTable();
                    $table=new easyTable($pdf, '{60,40,50,50}', 'width:100; border-color:#ffff00; font-size:12; border:1;');
                            $table->rowStyle('border:TBLR;border-color:#a1a1a1;bgcolor:#009879;align:C;font-color:#fff;');
                            $table->easyCell('Project and proponent name', 'align:C;font-size:12;font-style:B');
                            $table->easyCell('Source of fund', 'align:C;font-size:12;font-style:B');
                            $table->easyCell('Location', 'align:C;font-size:12;font-style:B');
                            $table->easyCell('Area', 'align:C;font-size:12;font-style:B');
            ...
            if ($chk_research) {
                if (!empty($research)) {
                    ...
                    $table=new easyTable($pdf, '{70,60,60}', 'width:100; border-color:#ffff00; font-size:12; border:1;');
                            $table->rowStyle('border:TBLR;border-color:#a1a1a1;bgcolor:#009879;align:C;font-color:#fff;');
                            $table->easyCell('Type of Research and Purpose', 'align:C;font-size:12;font-style:B;');
                            $table->easyCell('Permit', 'align:C;font-size:12;font-style:B;');
                            $table->easyCell('PAMB Resolution', 'align:C;font-size:12;font-style:B;');
                            $table->printRow();
        ...
        if ($chk_threats == 1) {
            if (!empty($threatMap)) {
                ...
                $table=new easyTable($pdf, '{40,75,75}', 'width:100; border-color:#ffff00; font-size:12; border:0;');
                    foreach($threats as $thrt) {
                        ...
                        if ($thrt->threats_longitude_dms_direction==1) {
                            $long="East";
                        }else if($thrt->threats_longitude_dms_direction==2){
                            $long="West";
                        }else{
                            $long="";
                        }
                        ...
                        if ($thrt->threats_latitude_dms_direction==1) {
                            $lat="North";
                        }else if($thrt->threats_latitude_dms_direction==2){
                            $lat="South";
                        }else{
                            $lat="";
                        }
                        $table->rowStyle('border:;border-color:#a1a1a1;');                           
                            $table->easyCell('','img:bmb_assets2/upload/img_threat/'.(!empty($thrt->img_threat)?$thrt->img_threat:"nophoto.jpg").', w80,h60;colspan:3;align:left'); 
                        $table->printRow();
                        $table->rowStyle('border:;border-color:#a1a1a1;');
                            $table->easyCell('Location : ', 'align:L;font-size:12;font-style:B');
                            $table->easyCell(iconv("UTF-8", '',(!empty($thrt->regionName)?$thrt->regionName.", ":"").(!empty($thrt->provinceName)?$thrt->provinceName.", ":"").(!empty($thrt->municipalName)?$thrt->municipalName.", ":"").(!empty($thrt->barangayName)?$thrt->barangayName:"")),'colspan:2');
                        $table->printRow();

                        $table->rowStyle('border:;border-color:#a1a1a1;');
                        $table->easyCell('Coordinates : ', 'align:L;font-size:12;font-style:B');
                            $table->easyCell(iconv("UTF-8", '',$long." ".(!empty($thrt->threats_longitude_dms_degrees)?$thrt->threats_longitude_dms_degrees."° ":"").(!empty($thrt->threats_longitude_dms_minutes)?$thrt->threats_longitude_dms_minutes."' ":"").(!empty($thrt->threats_longitude_dms_seconds)?$thrt->threats_longitude_dms_seconds."'' ":"")."\n".$lat." ".(!empty($thrt->threats_latitude_dms_degrees)?$thrt->threats_latitude_dms_degrees."° ":"").(!empty($thrt->threats_latitude_dms_minutes)?$thrt->threats_latitude_dms_minutes."' ":"").(!empty($thrt->threats_latitude_dms_seconds)?$thrt->threats_latitude_dms_seconds."'' ":"")),'colspan:2');
                        $table->printRow();
                        $table->rowStyle('border:;border-color:#a1a1a1;');
                        $table->easyCell('Date Assessed : ', 'align:L;font-size:12;font-style:B');
                            $table->easyCell(iconv("UTF-8", '',(!empty($thrt->month)?$thrt->month." ":"").(!empty($thrt->year)?$thrt->year:"")),'colspan:2');
                        $table->printRow();
                        ...
                        $table->rowStyle('border:TBRL;border-color:#a1a1a1;');
                            $table->easyCell('Nature of threats ', 'align:C;font-size:12;font-style:B');
                            $table->easyCell('Category  ', 'align:C;font-size:12;font-style:B');
                            $table->easyCell('Threats ', 'align:C;font-size:12;font-style:B');
                        $table->printRow();
                    foreach($threatsList as $listthreat) {
                    
                        if (!empty($listthreat)) {
                            $table->rowStyle('border:TBRL;border-color:#a1a1a1;');
                                $table->easyCell(iconv("UTF-8", '',(!empty($listthreat->natural_threats_desc)?$listthreat->natural_threats_desc:"")));
                                $table->easyCell(iconv("UTF-8", '',(!empty($listthreat->threats_category_desc)?$listthreat->threats_category_desc:"")));
                                $table->easyCell(iconv("UTF-8", '',(!empty($listthreat->sub_cat_desc)?$listthreat->sub_cat_desc:"")));
                            $table->printRow();
                        }
                    }  
                }
