...
function Header()
{
    ...
    $this->Ln(5);
    $this->SetFont('Times','B',12);
    $this->Cell(0,20,'List of existing Waterfowl in the Philippines',0,0,'C');
    // Line break
    $this->Ln(20);
    ...
    $this->cell($w[3],5,'Date Census',1,0,'C',true);
    $this->cell($w[4],5,'Discovered Species (no.)',1,1,'C',true);
}
