...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'denr-bmb-logo.gif')) {
		$tcpdf_header_logo = 'denr-bmb-logo.gif';
	}
...
if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'Department of Environment and Natural Resources');
}

if (!defined('PDF_HEADER_STRING')) {
	define ('PDF_HEADER_STRING', "Biodiversity Management Bureau\nwww.tcpdf.org");
}
