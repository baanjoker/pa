...
define('FPDF_FONTPATHS', __DIR__ . '/fpdf-easytable-master/easyTable.php');
define('FPDF_FONTPATHSS', __DIR__ . '/fpdf-easytable-master/formatedString.php');
...
class Pdf extends FPDF
{
    ...
    protected $head_title_top;
    protected $head_office;
    protected $head_address;
    protected $head_emailadd;
    protected $head_contact;
    ...
    **/
    function header()
    {
        ...
        $this->Image($this->logo,13,10,22);
        $this->SetFont( 'Times' , '' ,8 );
        $this->Cell(25);

        $this->Cell(120,0,$this->head_title_top,0,0,'L');
        $this->Ln('5');
        $this->SetFont('Times','B',12);
        $this->Cell(25);

        $this->SetTextColor(0, 0, 255);
        $this->Cell(120,0,$this->head_title,0,0,'L');
        $this->Ln('5');
